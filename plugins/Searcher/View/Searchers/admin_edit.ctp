...
<div class="actions">
    ...
    <ul>
        <?php echo $this->Permissions->postLink(__d('cms', 'Usuń'), array('plugin' => false, 'action' => 'delete', $this->Form->value('Searcher.id')), array('outter' => '<li>%s</li>'), __('Are you sure you want to delete # %s?', $this->Form->value('Searcher.id'))); ?>    
