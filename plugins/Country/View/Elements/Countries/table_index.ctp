...
<table cellpadding="0" cellspacing="0">
    ...
    foreach ($countries as $country):
        ...
        <tr attrId="<?php echo $country['Country']['id']; ?>">
            ...
            <td class="actions">
                <?php //echo $this->Permissions->link(__('View'), array('action' => 'view', $country['Country']['id'])); ?>
                <?php echo $this->Permissions->link(__('Edit'), array('action' => 'edit', $country['Country']['id'])); ?>
    <?php echo $this->Permissions->postLink(__('Delete'), array('action' => 'delete', $country['Country']['id']), null, __('Are you sure you want to delete # %s?', $country['Country']['name'])); ?>
            </td>
        </tr>
<?php endforeach; ?>
</table>