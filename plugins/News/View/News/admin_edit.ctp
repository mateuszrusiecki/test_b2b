<?php $this->set('title_for_layout', __d('cms', 'Adding').' &bull; '.__d('cms', 'News')); ?><h2><?php echo __d('cms', 'Admin Edit News'); ?></h2>
...
<div class="actions">
    ...
    <ul>
        <?php echo $this->Permissions->postLink(__d('cms', 'Delete'), array('action' => 'delete', $this->Form->value('News.id')), array('outter'=>'<li>%s</li>'), __('Are you sure you want to delete # %s?', $this->Form->value('News.title'))); ?> 
