<?php $this->Html->script('admin_menu', array('inline'=>false)); ?>
        <li class="firstLiTree">
            ...
            <fieldset>
                <legend>Dodaj nową pozycję menu</legend>
        ...
        <?php echo $this->Form->input('Tree.name', array('label' => __('Nazwa'),'onkeyup' => 'updateDragBox()')); ?>
        ...
        echo $this->Form->input('Category.option', array('legend' => __('Opcje'), 'type' => 'radio', 'options' => $categoryOptions, 'value' => '0')); ?>

        <div class="url-section">
            <?php echo $this->Form->input('Category.url', array('label' => __('Adres url'))); ?>
        </div>
        ...
        <?php //echo $this->Form->input('Category.page_id', array('label' => __('Adres url'))); ?>
            <?php echo $afterInput; ?>
