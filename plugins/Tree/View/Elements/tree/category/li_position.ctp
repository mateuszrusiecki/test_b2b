                ...
                <?php 
                 ...
                 ?>
                    ...
                    echo ' <div class="button">';
                      ...
                      echo '</div> ';                   
//array_merge($optionsFull, array('confirm'=>__('Usunąć pozycję, oraz wszystkie pozycje podrzędne?'), 'title'=>'Usuń wszystkie pozycje'))    
                                ...
                                if(count($value['translateDisplay'])>1){
                                  echo $this->element('flag', 
                                        array('url' => 
                                            ...
                                            'title'=> __d('cms','Usuń'),
                                            'addit' => array(
                                                    'confirm'=>__('Usunąć pozycję dla tego języka, oraz wszystkie pozycje podrzędne?')
                                                )
                                            )
                                        );
                                  }
                                 echo $this->Html->link($this->Html->image('flag/trash.png', array('alt' => __('Usuń Wszystkie'), 'title' => __('Usuń Wszystkie'))),
                                         array(
                                            'action' => 'delete', 
                                            'plugin' => 'tree', 
                                            'controller'=>'tree',
...
//                     echo $this->Html->link(__('Edycja'), array('admin'=>true, 'plugin' => false, 'controller'=>'categories', 'action'=>'edit', $value[$modelAlias]['id'], 'user' => false), array('class'=>'button')); 
// 
// 
// 
// 
//                 } else {
//                     echo $this->Html->link(__('Edycja artykułu'), array('admin'=>true, 'plugin' => false, 'controller'=>'albums', 'action'=>'edit', $value[$modelAlias]['model_id'], 'user' => false), array('class'=>'button')); 
//                 }
