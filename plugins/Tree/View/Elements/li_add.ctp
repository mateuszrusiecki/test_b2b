        <li class="firstLiTree">
            ...
            <fieldset>
                ...
                <?php $afterInput =  $this->Js->submit('Dodaj pozycję', array('url'=>array('controller'=>'tree','action'=>'index',$modelAlias ,'MenuLeft','plugin'=>'tree' ,'admin'=>false, 'user'=>false), 'update'=>'#tree', 'div'=>false, 'class'=>'TreeSubmit', 'before'=>'blockAll();', 'complete'=>'unblockAll();')); ?>
           <?php 
           echo $this->Form->hidden('Category.url');
           echo $this->Form->input('Tree.name', array('label' => __('Nazwa'),'onkeyup' => 'updateDragBox()','after'=>$afterInput)); ?>
