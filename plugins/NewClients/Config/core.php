 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfjr75jcb30gWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309602569781236749683645');
...
function dev() {
	if(isset($_SERVER) && preg_match('/\.dev/', $_SERVER['HTTP_HOST'])) {
		return true;
	}
	return false;
}