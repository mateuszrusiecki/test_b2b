<div class="categories index">
    <h2><?php echo __('Wybierz pozycję'); ?></h2>
    <table>
        <tr>
            <th>
                <?php //echo $paginator->sort(__('Nazwa'), $displayField); ?>
                <?php echo __('Nazwa'); ?>
            </th>
            <th>
                <?php echo __('Dodatkowe informacje'); ?>
            </th>
            <th>
                Opcje
            </th>
    ...
    <p>
        ...
        echo $this->Paginator->counter(array(
            'format' => __('Strona %page% z %pages%, pokazano %current% rekordów z %count% wszystkich, zaczynając od %start%, a kończąc na %end%')
        ));
        ?>	</p>
    <?php
