...
Class Asido_Driver_GD Extends Asido_Driver {
	...
	* @access protected
	*/
	function __resize($tmp, $width, $height, $x = null, $y = null, $w = null, $h = null) {
        ...
        $w = empty($w) ? $tmp->image_width : $w;
        $h = empty($h) ? $tmp->image_height : $h;
	...
	* @access protected
	*/
	public function __canvas($width, $height, $color) {
