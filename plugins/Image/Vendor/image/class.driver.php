...
Class Asido_Driver {
	...
	* @access public
	*/
	function resize($tmp, $width, $height, $x = null, $y = null, $w = null, $h = null, $mode = ASIDO_RESIZE_PROPORTIONAL) {
		...
		// do the resize
		//
		$r = $this->__resize($tmp, $p_width, $p_height, $x, $y, $w, $h);
	...
	*/
	function frame($tmp, $width, $height, $color=null) {
		...
		// resize it
		//
		if (!$this->resize($tmp, $width, $height, null, null, null, null, ASIDO_RESIZE_FIT)) {
			return false;
			}
