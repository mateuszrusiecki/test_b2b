...
class PhotosController extends AppController {
     ...
     *
     */
    public $helpers = array('Jcrop.Jcrop');
...
//        $this->Photo->id = $slug['id'];
    ...
    public function admin_reload($childModel) {
        $photo = $this->Photo->find('first', array('conditions' => array('Photo.id' => $this->data['id'])));
        //$response = $this->element('/Photos/photoBox', array('photo' => $photo));
        //$this->set('response', $response);
        $model = $childModel;

        $photo['Photo']['photo_id'] = $photo['Photo']['id'];
        $this->set(compact('photo', 'model'));
        $this->render('/Elements/Photos/photoBox');
    }
