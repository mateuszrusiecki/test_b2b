...
<table cellpadding="0" cellspacing="0">
    ...
    foreach ($photos as $photo):
        ...
        <tr attrId="<?php echo $photo['Photo']['id']; ?>">
            ...
            <td class="actions">
                <?php //echo $this->Permissions->link(__('View'), array('action' => 'view', $photo['Photo']['id'])); ?>
                <?php echo $this->Permissions->link(__('Edit'), array('action' => 'edit', $photo['Photo']['id'])); ?>
                <?php echo $this->Permissions->postLink(__('Delete'), array('action' => 'delete', $photo['Photo']['id']), null, __('Are you sure you want to delete # %s?', $photo['Photo']['title'])); ?>
            </td>
        </tr>
    <?php endforeach; ?>
</table>