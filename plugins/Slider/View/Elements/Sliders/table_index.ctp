	...
	<tr data-id="<?php echo $slider['Slider']['id']; ?>">
		<td style="text-align: center;"><?php echo $slider['Slider']['active'] ? 'TAK' : 'NIE'; ?>&nbsp;</td>
		...
		<td class="actions">
			<?php //echo $this->Permissions->link(__('View'), array('action' => 'view', $slider['Slider']['id'])); ?>
			<?php echo $this->Permissions->link(__('Edit'), array('action' => 'edit', $slider['Slider']['id'])); ?>
			<?php echo $this->Permissions->postLink(__('Delete'), array('action' => 'delete', $slider['Slider']['id']), null, __('Are you sure you want to delete # %s?', $slider['Slider']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
     </tbody>
