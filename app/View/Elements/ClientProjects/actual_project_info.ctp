<div ng-controller="SearchersCtrl">
    <div ng-init="clientProjects = <?php echo a(@$actualProject); ?>"></div>
    <div class="table-scrollable table-scrollable-borderless">
        <div class="clearfix">
            ...
            <a class="btn btn-sm yellow margin-bottom pull-right ml" href="<?php echo "/client_projects/view/" . $_GET['actual_project_id']; ?>">Powrót do projektu</a>
        </div>
