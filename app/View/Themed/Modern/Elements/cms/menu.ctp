<?php
MenuCMS::add(MenuCms::TOP, 'Strona główna/Portal', '/');
MenuCMS::add(MenuCms::TOP, 'Strona główna/CMS', '/admin');

MenuCMS::add(MenuCms::TOP, 'Zawartość/Strony', array('plugin' => 'page', 'admin' => 'admin', 'controller' => 'pages', 'action' => 'index'));
MenuCMS::add(MenuCms::TOP, 'Zawartość/Edycja menu', array('plugin' => 'menu', 'admin' => true, 'controller' => 'menus', 'action' => 'index'));
...
MenuCMS::add(MenuCms::TOP, 'ProfilBox', '#', array(
    'class' => 'avatar',
    'content' => $this->Html->image('static/demo/avatar.jpg', array('alt' => 'avatar'))
));

MenuCMS::add(MenuCms::TOP, 'ProfilBox/Jacques Alba', '#', array(
    'content' => __d('cms', 'Edytuj swój profil')
));

MenuCMS::add(MenuCms::TOP, 'ProfilBox/Sign out', '#', array(
    'class' => 'avatar',
    'content' => $this->Html->image('static/demo/avatar.jpg', array('alt' => 'avatar'))
));

MenuCMS::add(MenuCms::TOP, 'Wyszukiwarka', '#', array(
    'class' => 'search',
    'content' => $this->Form->input('search', array('type' => 'text', 'placeholder' => __d('cms', 'Search'))) 
));


MenuCMS::add(MenuCms::TOP, 'Administracja/Użytkownicy', array('plugin' => 'user', 'admin' => 'admin', 'controller' => 'users', 'action' => 'index'));
