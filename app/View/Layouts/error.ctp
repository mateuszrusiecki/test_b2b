...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="portlet light col-xs-12" style="text-align: center">
                <h3>Błąd 404</h3>
                <p>NIE ZNALEZIONO STRONY</p>
                <p> Wygląda na to, że strona o podanym adresie nie istnieje. Zapraszamy do skorzystania z nawigacji powyżej.</p>
            </div>
    ...
    <table class="dotacja">
        <tr>
            <td style="text-align:left;">
                <img src="/uploaded/ue/poig.png" alt='poig' style="max-height: 100px"/></td>
