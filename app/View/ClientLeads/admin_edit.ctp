...
<?php echo $this->Form->create('ClientLead'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Client Lead'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ClientLead.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ClientLead.id'))); ?></li>
