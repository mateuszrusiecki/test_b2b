    ...
    <div class="row">
        <div class="col-md-6 col-xs-12">
            ...
            echo $this->Metronic->input('position', array(
                ...
                'value' => $user_contract_history['UserContractHistory']['position'],
                'required' => 'required',
            ));
            ...
            echo $this->Metronic->input('employment_start', array(
                ...
                'value' => $user_contract_history['UserContractHistory']['employment_start'],
                'required' => 'required',
            ...
            echo $this->Metronic->input('employment_end', array(
                ...
                //'placeholder'=> __d('public','Data od'),
                'type' => 'text',
                'value' => $user_contract_history['UserContractHistory']['employment_end'],
                'class' => 'form-control form-control-inline date-picker',
                'between' => '<i class="icon-calendar"></i>'
            ));
            ...
            echo $this->Form->input('working_time', array(
                ...
                , 'side' => "right",
                'options' => array(
                    '1.0' => __d('public', 'Pełny'), '0.75' => '3/4', '0.5' => '1/2', '0.25' => '1/4'
                )
        ...
        <div class="col-md-6 col-xs-12">
            ...
            echo $this->Metronic->input('vacation_days', array(
                ...
                'value' => $user_contract_history['UserContractHistory']['vacation_days'],
            ));
//            echo $this->Metronic->input('salary_adjustment', array(
//                'label' => 'Korekta wynagrodzenia',
//				'value' => $user_contract_history['UserContractHistory']['salary_adjustment'],
//            ));
//		
...
//				'type' => 'text',
//				'class' => 'form-control form-control-inline date-picker',
//				'value' => $user_contract_history['UserContractHistory']['salary_date_from'],
//				'between' => '<i class="icon-calendar"></i>'
//			));
...
//				'type' => 'text',
//				'class' => 'form-control form-control-inline date-picker',
//				'value' => $user_contract_history['UserContractHistory']['salary_date_to'],
//				'between' => '<i class="icon-calendar"></i>'
//			));
//			
            ?>
