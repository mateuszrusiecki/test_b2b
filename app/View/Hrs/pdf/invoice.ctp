        ...
        <div class="rightPage">
            <div id="data">
                <div class="dataHeader pb10">
                    <div class="grey">
                        <?php if($invoice['Invoice']['type'] == 3){
							echo __d('public','Faktura PROFORMA');
						} else {
							echo __d('public','Faktura VAT');
						}
						?>
                    </div>
                    <?php if($invoice['Invoice']['type'] != 3) echo 'nr '.$invoice['Invoice']['invoice_nr'] ?>
                </div>
