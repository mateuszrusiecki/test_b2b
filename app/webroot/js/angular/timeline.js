...
angular.module('destegabry.timeline', [])
        .directive('timeline', function ($compile, $timeout) {
            ...
            return {
                ...
                link: function ($scope, $element) {
                    ...
                    $scope.compile = function (timeline) {
                        var elePop = $('.timeline-event-content');
                        angular.forEach(elePop, function (v) {
                            $compile(angular.element(v))($scope)
                        });
                    }
                }
            };
