...
(function($)
{
    ...
    $.fn.date = function(method)
    {
        if(methods[method]) {
            ...
            $.error("Method "+ method + " does not exist on jQuery.date");
        }
    };
})(jQuery);
...
(function(a){
    function c(a,b){
        ...
        n.beginPath();
        if(b.points.symbol=="circle")n.arc(d,e,i,0,2*Math.PI,false);else b.points.symbol(n,d,e,i,false);
        n.closePath();
        n.stroke()
        }
        function bu(a,b){
    ...
    for(a=0;a<bj.length;++a){
        b=bj[a];
        if(b.series.bars.show)bw(b.series,b.point);else bv(b.series,b.point)
            }
            n.restore();
    x(v.drawOverlay,[n])
    }
    ...
    if(!bk)bk=setTimeout(br,30)
        ...
        function bp(a,c,d){
    var e=l.offset(),f=c.pageX-e.left-q.left,g=c.pageY-e.top-q.top,i=E({
        left:f,
        top:g
    });
    i.pageX=c.pageX;
    ...
    function bl(a,b,c){
    var d=h.grid.mouseActiveRadius,e=d*d+1,f=null,i=false,j,k;
    for(j=g.length-1;j>=0;--j){
        if(!c(g[j]))continue;
        var l=g[j],m=l.xaxis,n=l.yaxis,o=l.datapoints.points,p=l.datapoints.pointsize,q=m.c2p(a),r=n.c2p(b),s=d/m.scale,t=d/n.scale;
        ...
        if(l.lines.show||l.points.show){
            for(k=0;k<o.length;k+=p){
                ...
                var w=Math.abs(m.p2c(u)-a),x=Math.abs(n.p2c(v)-b),y=w*w+x*x;
                if(y<e){
                    e=y;
                    f=[j,k/p]
                    }
        ...
        if(l.bars.show&&!f){
        var z=l.bars.align=="left"?0:-l.bars.barWidth/2,A=z+l.bars.barWidth;
        for(k=0;k<o.length;k+=p){
            var u=o[k],v=o[k+1],B=o[k+2];
            if(u==null)continue;
...
function bi(){
    ...
    var c=[],d=false,e=h.legend.labelFormatter,f,i;
    ...
    if(h.legend.container!=null)a(h.legend.container).html(k);
        ...
        var l="",m=h.legend.position,n=h.legend.margin;
        if(n[0]==null)n=[n,n];
        ...
        if(h.legend.backgroundOpacity!=0){
            ...
            if(p==null){
                ...
                if(p&&typeof p=="string")p=a.color.parse(p);else p=a.color.extract(o,"background-color");
                p.a=1;
                p=p.toString()
                }
                var r=o.children();
    ...
    for(var d=0;d<c.length;++d){
        ...
        for(var g=0;g<e.ticks.length;++g){
            ...
            if(e.direction=="x"){
                ...
                if(e.position=="bottom")i.top=f.top+f.padding;else i.bottom=s-(f.top+f.height-f.padding)
                    }else{
        ...
        for(var l in i)k.push(l+":"+i[l]+"px");a.push('<div class="tickLabel" style="'+k.join(";")+'">'+h.label+"</div>")
            }
            a.push("</div>")
        }
        a.push("</div>");
...
function ba(){
    ...
    var d=D(),i=h.grid.borderWidth;
for(var j=0;j<d.length;++j){
    var k=d[j],l=k.box,n=k.tickLength,o,p,r,s;
    if(!k.show||k.ticks.length==0)continue;
    m.strokeStyle=k.options.tickColor||a.color.parse(k.options.color).scale("a",.22).toString();
    m.lineWidth=1;
    if(k.direction=="x"){
        o=0;
        if(n=="full")p=k.position=="top"?0:u;else p=l.top-q.top+(k.position=="top"?l.height:0)
            }else{
        p=0;
        if(n=="full")o=k.position=="left"?0:t;else o=l.left-q.left+(k.position=="left"?l.width:0)
            }
            if(!k.innermost){
        m.beginPath();
        r=s=0;
        if(k.direction=="x")r=t;else s=u;
        if(m.lineWidth==1){
            o=Math.floor(o)+.5;
            p=Math.floor(p)+.5
            }
    ...
    for(b=0;b<k.ticks.length;++b){
        ...
        if(k.direction=="x"){
            ...
            if(k.position=="left")r=-r
                ...
                if(m.lineWidth==1){
            if(k.direction=="x")o=Math.floor(o)+.5;else p=Math.floor(p)+.5
                }
                m.moveTo(o,p);
        m.lineTo(o+r,p+s)
        }
...
function W(b){
    ...
    var d=b.options;
    var e;
    if(typeof d.ticks=="number"&&d.ticks>0)e=d.ticks;else e=.3*Math.sqrt(b.direction=="x"?r:s);
    var f=(b.max-b.min)/e,g,h,i,j,k,l,m;
    if(d.mode=="time"){
        var n={
            second:1e3,
            minute:60*1e3,
        ...
        var q=[[1,"second"],[2,"second"],[5,"second"],[10,"second"],[30,"second"],[1,"minute"],[2,"minute"],[5,"minute"],[10,"minute"],[30,"minute"],[1,"hour"],[2,"hour"],[4,"hour"],[8,"hour"],[12,"hour"],[1,"day"],[2,"day"],[3,"day"],[.25,"month"],[.5,"month"],[1,"month"],[2,"month"],[3,"month"],[6,"month"],[1,"year"]];
        var t=0;
        if(d.minTickSize!=null){
            if(typeof d.tickSize=="number")t=d.tickSize;else t=d.minTickSize[0]*n[d.minTickSize[1]]
                }
                for(var k=0;k<q.length-1;++k)if(f<(q[k][0]*n[q[k][1]]+q[k+1][0]*n[q[k+1][1]])/2&&q[k][0]*n[q[k][1]]>=t)break;g=q[k][0];
        i=q[k][1];
        if(i=="year"){
            ...
            else if(m<7.5)g=5;else g=10;
            g*=l
            }
            b.tickSize=d.tickSize||[g,i];
        h=function(a){
            var b=[],d=a.tickSize[0],e=a.tickSize[1],f=new Date(a.min);
            var g=d*n[e];
        ...
        j=function(b,c){
            ...
            if(f<n.minute)fmt="%h:%M:%S"+h;
                ...
                if(g<2*n.day)fmt="%h:%M"+h;else fmt="%b %d %h:%M"+h
                    }else if(f<n.month)fmt="%b %d";
            else if(f<n.year){
                if(g<n.year)fmt="%b";else fmt="%b %y"
                    }else fmt="%y";
...
h=function(a){
    var b=[];
    var d=c(a.min,a.tickSize),e=0,f=Number.NaN,g;
    do{
        g=f;
        f=d+e*a.tickSize;
        b.push(f);
...
if(d.alignTicksWithAxis!=null){
    ...
    if(w&&w.used&&w!=b){
        ...
        if(b.mode!="time"&&d.tickDecimals==null){
            var y=Math.max(0,-Math.floor(Math.log(f)/Math.LN10)+1),z=h(b);
...
function R(b){
    var c=b.labelWidth,d=b.labelHeight,e=b.options.position,f=b.options.tickLength,g=h.grid.axisMargin,i=h.grid.labelMargin,j=b.direction=="x"?o:p,k;
...
function Q(c){
    function l(d,e){
        ...
        var d=c.options,e,f=c.ticks||[],g=[],h,i=d.labelWidth,j=d.labelHeight,k;
    if(c.direction=="x"){
...
function P(a){
    ...
    function t(a,b,c){
        ...
        if(c>a.datamax&&c!=d)a.datamax=c
            ...
            var b=Number.POSITIVE_INFINITY,c=Number.NEGATIVE_INFINITY,d=Number.MAX_VALUE,e,f,h,i,j,k,l,m,n,o,p,q,r,s;
    ...
    for(e=0;e<g.length;++e){
        ...
        for(e=0;e<g.length;++e){
        k=g[e];
        var u=k.data,w=k.datapoints.format;
        if(!w){
            w=[];
            w.push({
                x:true,
...
function H(){
    ...
    for(b=0;b<g.length;++b){
        ...
        if(f!=null){
            --c;
            if(typeof f=="number")e.push(f);else d.push(a.color.parse(g[b].color))
                }
            }
...
while(i.length<c){
    var k;
    if(h.colors.length==b)k=a.color.make(100,100,100);else k=a.color.parse(h.colors[b]);
    var l=j%2==1?-1:1;
...
function E(a){
    ...
    for(var d in v)if(h.hooks[d]&&h.hooks[d].length)v[d]=v[d].concat(h.hooks[d]);x(v.processOptions,[h])
    }
    function y(){
...
(function(a){
    function c(b){
        function f(a,b){
            var c=b.curvePointFactor*a.length;
            var d=new Array;
            var e=new Array;
            if(b.fit){
                var f=b.fitPointDist;
                var g=0;
                for(var h=0;h<a.length;h++){
                    d[g]=a[h][0]-.1;
                    if(h>0){
                        e[g]=a[h-1][1]*f+a[h][1]*(1-f)
                        }else{
                        e[g]=a[h][1]
                        }
                        g++;
    ...
    for(var h=1;h<i-1;++h){
        ...
        var n=m*j[h-1]+2;
        j[h]=(m-1)/n;
        k[h]=(e[h+1]-e[h])/(d[h+1]-d[h])-(e[h]-e[h-1])/(d[h]-d[h-1]);
        k[h]=(6*k[h]/(d[h+1]-d[h-1])-m*k[h-1])/n
        }
        for(var g=i-2;g>=0;--g){
        j[g]=j[g]*j[g+1]+k[g]
        }
    ...
    if(v==0){
        ...
        var w=(d[s]-p[g])/v;
        var x=(p[g]-d[t])/v;
        q[g]=w*e[t]+x*e[s]+((w*w*w-w)*j[t]+(x*x*x-x)*j[s])*v*v/6;
        r.push(p[g]);
        r.push(q[g])
        }
        return r
...
function e(a,b,c,d,e){
    ...
    var i=0;
    a.beginPath();
    for(var j=f;j<b.length;j+=f){
        var k=b[j-f],l=b[j-f+1];
        var m=b[j],n=b[j+1];
        ...
        if(l<=n&&l<d.min){
            ...
            if(k!=g||l!=h)a.lineTo(c.p2c(k),d.p2c(l));
        if(g==null){
            i=n
            }
            g=m;
        h=n;
        a.lineTo(c.p2c(m),d.p2c(n))
        }
        if(e){
        a.lineTo(c.p2c(c.max),d.p2c(d.min));
        a.lineTo(c.p2c(c.min),d.p2c(d.min));
        a.lineTo(c.p2c(c.min),d.p2c(i));
        a.fill()
        }
        a.stroke()
    }
    ...
    for(var i=0;i<g.length;i++){
        d=g[i];
        if(d.curvedLines.show&&d.curvedLines.lineWidth>0){
            axisx=d.xaxis;
            axisy=d.yaxis;
            c.save();
            c.translate(h.left,h.top);
            c.lineJoin="round";
            c.strokeStyle=d.color;
            if(d.curvedLines.fill){
                var j=d.curvedLines.fillColor==null?d.color:d.curvedLines.fillColor;
                var k=a.color.parse(j);
                k.a=typeof fill=="number"?fill:.4;
                k.normalize();
                c.fillStyle=k.toString()
                }
                c.lineWidth=d.curvedLines.lineWidth;
            var l=f(d.data,d.curvedLines);
            e(c,l,axisx,axisy,d.curvedLines.fill);
            c.restore()
            }
        }
    }
...
(function(i){
    ...
    var d=i.event,c=d.special,h=c.drag={
        not:":input",
        distance:0,
        which:1,
        dragging:false,
...
$.fn.wysiwym = function(markupSet, options) {
    ...
    this.initializeButtons = function() {
        ...
        for (var i=0; i<markup.buttons.length; i++) {
            ...
            if (i == 0) {
                jqbutton.addClass('first');
            }
            if (i == markup.buttons.length-1) {
                jqbutton.addClass('last');
            }
...
Wysiwym.list = function(event) {
    ...
    if (wysiwym.selection.linesHavePrefix(regex?regex:prefix)) {
        ...
        if (wrap) {
            wysiwym.selection.unwrapBlankLines();
        }
    } else {
        wysiwym.selection.setLinePrefixes(prefix, regex);
        if (wrap) {
            wysiwym.selection.wrapBlankLines();
        }
    }
    wysiwym.update();
};
...
Wysiwym.Markdown = function(textarea) {
    ...
    this.buttons = [
    new Wysiwym.Button('Bold',   Wysiwym.span,  {
        prefix:'**', 
        suffix:'**', 
        text:'strong text'
    }),
    new Wysiwym.Button('Italic', Wysiwym.span,  {
        prefix:'_',  
        suffix:'_',  
        text:'italic text'
    }),
    new Wysiwym.Button('Link',   Wysiwym.span,  {
        prefix:'[',  
        suffix:'](http://example.com)', 
        text:'link text'
    }),
    new Wysiwym.Button('Bullet List', Wysiwym.list, {
        prefix:'* ', 
        wrap:true
    }),
    new Wysiwym.Button('Number List', Wysiwym.list, {
        prefix:'0. ', 
        wrap:true, 
        regex:/^\s*\d+\.\s/
    }),
    new Wysiwym.Button('Quote',  Wysiwym.list,  {
        prefix:'> ',   
        wrap:true
    }),
    new Wysiwym.Button('Code',   Wysiwym.block, {
        prefix:'    ', 
        wrap:true
    })
    ];
    ...
    },
{
        ...
        syntax: '(Begin lines with 4 spaces)'
    },
{
...
Wysiwym.Mediawiki = function(textarea) {
    ...
    new Wysiwym.Button('Quote',  Wysiwym.span,  {
        prefix:'<blockquote>', 
        suffix:'</blockquote>', 
        text:'quote text'
    }),
    new Wysiwym.Button('Code', Wysiwym.span,  {
        prefix:'<pre>', 
        suffix:'</pre>', 
        text:'code text'
    })
...
{
        label: 'Blockquote', 
        syntax: '&lt;blockquote&gt;quote&lt;/blockquote&gt;'
    },
{
        label: 'Large Code Block', 
        syntax: '&lt;pre&gt;Code block&lt;/pre&gt;'
    }
    ];
};
...
{
        label: 'Link',   
        syntax: '[url="http://example.com"]pk![/url]'
    },
{
        label: 'Blockquote', 
        syntax: '[quote]quote text[/quote]'
    },
{
        label: 'Large Code Block', 
...
String.prototype.endswith = function(str) {
    return this.substring(str.length, this.length) == str;
};
            ...
            if(org_title != ""){
                ...
                function active_tooltip() {
                    ...
                    timeout = setTimeout(function(){
                        tooltip.stop(true,true).fadeIn(opts.fadeIn);
                    }, opts.delay);	
                }
...
(function($){
    $.change = function(page, title, first) {
        if(!$(page).length>0) {
            $.info({
                desc: "The hash <strong>"+page+"</strong> is not valid"
                });
        } else {
