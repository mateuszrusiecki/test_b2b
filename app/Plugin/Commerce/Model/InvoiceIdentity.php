...
//	public $order = 'InvoiceIdentity.created DESC';
    ...
    public function beforeValidate($options = array()) {
		$this->validate['iscompany']['boolean']['message'] = __d('validate', 'Podaj rodzaj zakupów');
		$this->validate['name']['notempty']['message'] = __d('validate', 'Podaj imię nazwisko lub nazwę');
		$this->validate['address']['notempty']['message'] = __d('validate', 'Podaj ulicę');
		$this->validate['city']['notempty']['message'] = __d('validate', 'Podaj miejscowość');
		$this->validate['post_code']['notempty']['message'] = __d('validate', 'Podaj kod pocztowy');
		$this->validate['nip']['notempty']['message'] = __d('validate', 'Podaj NIP');
