...
//        '1' => 'Płatność elektroniczna',
        '2' => 'Platność za pobraniem/przy odbiorze'
    );
...
//			),
    ...
    function recalculateShipmentPrice($id = null) {
        ...
        $this->data['Order']['shipment_price'] = $myShipment['ShipmentMethod']['price_net'];
        if ($this->data['Order']['payment_type'] == 0) {
    ...
    function reorganizeShipment($shipment_method_id, $weight) {
        ...
        $params['order'] = 'ShipmentMethodConfig.id ASC';
        $params['limit'] = 1;
