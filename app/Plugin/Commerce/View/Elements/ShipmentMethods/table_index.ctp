	...
	<tr attrId="<?php echo $shipmentMethod['ShipmentMethod']['id']; ?>">
		...
		<td class="actions">
			...
			<?php echo $this->Permissions->postLink(__('Delete'), array('action' => 'delete', $shipmentMethod['ShipmentMethod']['id']), null, __('Are you sure you want to delete # %s?', $shipmentMethod['ShipmentMethod']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>