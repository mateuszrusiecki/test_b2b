	...
	<tr attrId="<?php echo $customer['Customer']['id']; ?>">
		...
		<td>
			<?php echo $this->Permissions->link($customer['Address']['name'], array('controller' => 'addresses', 'action' => 'view', $customer['Address']['id'])); ?>
		</td>
		...
		<td class="actions">
			...
			<?php echo $this->Permissions->postLink(__('Delete'), array('action' => 'delete', $customer['Customer']['id']), null, __('Are you sure you want to delete # %s?', $customer['Customer']['contact_person'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>