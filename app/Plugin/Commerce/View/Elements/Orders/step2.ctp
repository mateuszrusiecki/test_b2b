...
<div class="clearfix productsLogin">
    <div>
        ...
        echo $this->Form->input('accept', array('type' => 'checkbox', 'label' => 'Akceptuje warunki', 'id' => 'accept_box'));
        echo $this->Form->submit('Kontynuuj', array('id' => 'guest_submit', 'onClick' => "show_step('3')"));
        ?>
    </div>
    <div>
        <span class="productOr"><?php echo __d('public','lub') ?></span>
        <div class="productsLoginLabel">Rejestracja</div>
        <?php
        echo $this->Form->input('email', array('id' => 'login_r','label'=>false));
        echo $this->Form->input('name', array('id' => 'name_r','label'=>false));
        echo $this->Form->input('terms', array('type' => 'checkbox', 'label' => 'Akceptuję warunki', 'id' => 'terms'));
    ...
    <div>
        ...
        <?php
        echo $this->Form->input('email', array('id' => 'login_l','label'=>false));
        echo $this->Form->input('pass', array('type' => 'password', 'id' => 'password_l','label'=>false));
