	...
	<tr attrId="<?php echo $orderStatus['OrderStatus']['id']; ?>">
		...
		<td class="actions">
			...
			<?php echo $this->Permissions->postLink(__('Delete'), array('action' => 'delete', $orderStatus['OrderStatus']['id']), null, __('Are you sure you want to delete # %s?', $orderStatus['OrderStatus']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>