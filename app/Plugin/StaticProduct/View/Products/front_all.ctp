<?php foreach($products as $product):?>    
    <div class="borderBottomBox">
        <div class="clearfix brandPrice">
            ...
            <?php echo $this->Image->thumb('/files/photo/' . $product['Photo']['img'], array('width' =>78, 'height' => 78 ,'frame'=>'#ffffff'), array(
                'url'=> $productlink,
                'class' => 'fl'
            )); ?>
        ...
        <div class="textRight">
            <?php echo $this->Html->link(__d('public', 'Kaufen') . '&nbsp;»', array('plugin' => 'commerce', 'controller' => 'order_items', 'action' => 'add', $product['Product']['id']), array('escape' => false)); ?>
        </div>
    </div>  
