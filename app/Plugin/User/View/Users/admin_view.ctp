<div class="users view">
    ...
    <h2><?php echo __d('cms', 'Użytkownik należy do %s', 'grup'); ?></h2>
...
<div class="actions">
    <ul>
        <li><?php echo $this->Html->link(__d('cms', 'Edytuj %s', 'użytkownika'), array('action' => 'edit', $user['User']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__d('cms', 'Usuń %s', 'użytkownika'), array('action' => 'delete', $user['User']['id']), null, __d('cms', 'Jesteś pewien, że chcesz usunąć użytkownika "%s"?', $user['User']['email'])); ?> </li>
        <li><?php echo $this->Html->link(__d('cms', 'Lista %s', 'użytkowników'), array('action' => 'index')); ?> </li>
    </ul>
</div>
