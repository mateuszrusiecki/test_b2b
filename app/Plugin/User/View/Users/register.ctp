<div id="registerBox">
    <?php 
     ...
     echo $this->Form->input('email', array('label' => __d('users', 'E-mail')));
     ...
     $rules_link = $this->Html->link(__d('users', 'Regulaminem'), array('controller' => 'pages', 'action' => 'view', 'regulamin'));
     $privacy_policy_link = $this->Html->link(__d('users', 'Polityką prywatności'), array('controller' => 'pages', 'action' => 'view', 'polityka-prywatnosci'));
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__d('users', 'Logowanie/Rejestracja Facebook'), array('action' => 'login_facebook')); ?></li>
	</ul>
</div>
