...
//			'joinTable' => 'requesters_permissions',
    ...
    function getLastModified(){
        list(list($modified)) = $this->query("SELECT MAX(modified) AS last_modified FROM {$this->RequestersPermission->tablePrefix}requesters_permissions;");
        return $modified['last_modified'];
    }

    function getCountPermissions(){
        list(list($counter)) = $this->query("SELECT COUNT(id) AS counter FROM {$this->RequestersPermission->tablePrefix}requesters_permissions;");
