...
<div class="comments index">
    <h2><?php echo __('Komentarze do moderacji'); ?></h2>
    <table cellpadding="0" cellspacing="0">
        ...
        foreach ($comments as $comment):
            ...
            <tr<?php echo $class; ?> id="display_<?php echo $comment['Comment']['id']; ?>">
                ...
                <td class="actions">
                    <?php echo $this->Js->link(__('Usuń'), array('action' => 'delete', $comment['Comment']['id']), array('update' => '#display_' . $comment['Comment']['id'])); ?>
...
<div class="actions">
    <ul>
        <li><?php echo $this->Html->link(__('zaakceptowane'), array('action' => 'active')); ?></li>
    </ul>
</div>
