<?php $data = $this->requestAction(array('admin' => 'admin', 'prefix' => 'admin', 'controller' => 'panel', 'action' => 'analytics_page_path')); ?>
<div style="width: 800px;">
    <h2><span><?php echo __d('cms', 'Popularne podstrony'); ?></span></h2>
    <table cellspacing="0" cellpadding="0" style="margin: 10px 0;">
        <tr>
            <th><?php echo __d('cms', 'Strony'); ?></th>
            <th><?php echo __d('cms', 'Odsłony'); ?></th>
        </tr>
