...
?>
<div>
    <h2><span><?php echo __d('cms', 'Źródła odwiedzin'); ?></span></h2>
    <table cellspacing="0" cellpadding="0" style="width:400px; margin: 10px 0;">
        <tr>
            <th><?php echo __d('cms', 'Źródła'); ?></th>
            <th><?php echo __d('cms', 'Odwiedziny'); ?></th>
        </tr>
                ...
                <tr<?php echo $altrow; ?>>
                    <td title="<?php echo $row['GoogleAnalyticsAccount']['dimensions']['@value']; ?>" >
                        ...
                        echo $this->Text->truncate(
                                $row['GoogleAnalyticsAccount']['dimensions']['@value'], 40, array('exact' => true, 'ending' => '…')
                        );
                        ?>
                    </td>
