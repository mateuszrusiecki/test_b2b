...
class ActiveResource {
	 ...
	 *     GET /collection/id/method.xml?attr=value
	 */
	function getCurrnetUserId () {
		//$req = $this->site . 'users/current.xml';
//		$params = '';
...
//		$params .= '</' . $el . '>';
		...
		$res = $this->_fetch ($this->site.'users/current.xml', 'GET', ''); //'' = $params
		...
		$user_id = json_decode( json_encode($xml) , 1);
	...
	/**
	 * Gets issue asigned to
	 *
	 *     GET /collection/id/method.xml
	 *     GET /collection/id/method.xml?attr=value
	 */
	function getIssuesAssignedTo ($id) {
		//$req = $this->site . 'users/current.xml';
//		$params = '';
//		$el = $start_tag ? $start_tag : $this->element_name; // Singular this time
//		
...
//		$params .= '</' . $el . '>';
		...
		$res = $this->_fetch ($this->site.'/issues.xml?assigned_to_id='.$id, 'GET', ''); //'' = $params
